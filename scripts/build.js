...
parallel("yarn workspace @gatsby-tv/icons run build", "yarn workspace @gatsby-tv/utilities run build");
run("yarn workspace @gatsby-tv/components run build");
parallel("yarn workspace @gatsby-tv/preview run build", "yarn workspace @gatsby-tv/player run build");
